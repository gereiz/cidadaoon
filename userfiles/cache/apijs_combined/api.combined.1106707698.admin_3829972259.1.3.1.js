(function () {
    ...
    mw.settings = {
        ...
        debug: true,
        basic_mode: false,
        site_url: 'http://localhost/cidadaoon/',
        template_url: 'http://localhost/cidadaoon/userfiles/templates/new-world/',
        modules_url: 'http://localhost/cidadaoon/userfiles/modules/',
        includes_url: 'http://localhost/cidadaoon/userfiles/modules/microweber/',
        upload_url: 'http://localhost/cidadaoon/api/upload/',
        api_url: 'http://localhost/cidadaoon/api/',
        libs_url: 'http://localhost/cidadaoon/userfiles/modules/microweber/api/libs/',
        api_html: 'http://localhost/cidadaoon/api_html/',
    ...
    const Ziggy = {"url":"http:\/\/localhost\/cidadaoon","port":null,"defaults":{},"routes":{"api.":{"uri":"api\/offers_get_by_product_id","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"admin.user.index":{"uri":"admpainel\/user","methods":["GET","HEAD"]},"admin.user.store":{"uri":"admpainel\/user","methods":["POST"]},"admin.user.update":{"uri":"admpainel\/user\/{user}","methods":["PUT","PATCH"]},"admin.user.destroy":{"uri":"admpainel\/user\/{user}","methods":["DELETE"]},"logout":{"uri":"logout","methods":["GET","HEAD"]},"logout.submit":{"uri":"logout","methods":["POST"]},"verification.verify":{"uri":"email\/verify\/{id}\/{hash}","methods":["GET","HEAD"]},"verification.resend":{"uri":"email\/verify-resend\/{id}\/{hash}","methods":["GET","HEAD"]},"verification.send":{"uri":"email\/verify-resend\/{id}\/{hash}","methods":["POST"]},"checkout.forgot_password":{"uri":"forgot-password","methods":["GET","HEAD"]},"password.email":{"uri":"forgot-password","methods":["POST"]},"password.reset":{"uri":"reset-password\/{token}","methods":["GET","HEAD"]},"password.update":{"uri":"reset-password","methods":["POST"]},"api.users.export_my_data":{"uri":"api\/users\/export_my_data","methods":["GET","HEAD"]},"admin.login":{"uri":"admpainel\/login","methods":["GET","HEAD"]},"api.user.login":{"uri":"api\/user\/login","methods":["POST"]},"api.user.logout":{"uri":"api\/user\/logout","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.user.register":{"uri":"api\/user\/register","methods":["POST"]},"api.user.password.email":{"uri":"api\/user\/forgot-password","methods":["POST"]},"api.user.password.update":{"uri":"api\/user\/reset-password","methods":["POST"]},"api.user.profile.update":{"uri":"api\/user\/profile-update","methods":["POST"]},"api.api.logout":{"uri":"api\/logout","methods":["GET","HEAD"]},"api.user.index":{"uri":"api\/user","methods":["GET","HEAD"]},"api.user.store":{"uri":"api\/user","methods":["POST"]},"api.user.show":{"uri":"api\/user\/{user}","methods":["GET","HEAD"]},"api.user.update":{"uri":"api\/user\/{user}","methods":["PUT","PATCH"]},"api.user.destroy":{"uri":"api\/user\/{user}","methods":["DELETE"]},"livewire.message":{"uri":"livewire\/message\/{name}","methods":["POST"]},"livewire.upload-file":{"uri":"livewire\/upload-file","methods":["POST"]},"livewire.preview-file":{"uri":"livewire\/preview-file\/{filename}","methods":["GET","HEAD"]},"admin.language.save":{"uri":"admpainel\/language\/save","methods":["POST"]},"admin.language.import":{"uri":"admpainel\/language\/import","methods":["POST"]},"admin.language.export":{"uri":"admpainel\/language\/export","methods":["POST"]},"admin.language.send_to_us":{"uri":"admpainel\/language\/send_to_us","methods":["POST"]},"admin.language.import_missing_translations":{"uri":"admpainel\/language\/import_missing_translations","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.page.index":{"uri":"api\/page","methods":["GET","HEAD"]},"api.page.store":{"uri":"api\/page","methods":["POST"]},"api.page.show":{"uri":"api\/page\/{page}","methods":["GET","HEAD"]},"api.page.update":{"uri":"api\/page\/{page}","methods":["PUT","PATCH"]},"api.page.destroy":{"uri":"api\/page\/{page}","methods":["DELETE"]},"admin.page.index":{"uri":"admpainel\/page","methods":["GET","HEAD"]},"admin.page.create":{"uri":"admpainel\/page\/create","methods":["GET","HEAD"]},"admin.page.store":{"uri":"admpainel\/page","methods":["POST"]},"admin.page.edit":{"uri":"admpainel\/page\/{page}\/edit","methods":["GET","HEAD"]},"admin.page.update":{"uri":"admpainel\/page\/{page}","methods":["PUT","PATCH"]},"admin.page.destroy":{"uri":"admpainel\/page\/{page}","methods":["DELETE"]},"api.content.get_admin_js_tree_json":{"uri":"api\/content\/get_admin_js_tree_json","methods":["GET","HEAD"]},"api.content.store":{"uri":"api\/content","methods":["POST"]},"api.content.save_edit":{"uri":"api\/save_edit","methods":["POST"]},"admin.content.index":{"uri":"admpainel\/content","methods":["GET","HEAD"]},"admin.content.create":{"uri":"admpainel\/content\/create","methods":["GET","HEAD"]},"admin.content.store":{"uri":"admpainel\/content","methods":["POST"]},"admin.content.edit":{"uri":"admpainel\/content\/{content}\/edit","methods":["GET","HEAD"]},"admin.content.update":{"uri":"admpainel\/content\/{content}","methods":["PUT","PATCH"]},"admin.content.destroy":{"uri":"admpainel\/content\/{content}","methods":["DELETE"]},"admin.category.index":{"uri":"admpainel\/category","methods":["GET","HEAD"]},"admin.category.create":{"uri":"admpainel\/category\/create","methods":["GET","HEAD"]},"admin.category.store":{"uri":"admpainel\/category","methods":["POST"]},"admin.category.show":{"uri":"admpainel\/category\/{category}","methods":["GET","HEAD"]},"admin.category.edit":{"uri":"admpainel\/category\/{category}\/edit","methods":["GET","HEAD"]},"admin.category.update":{"uri":"admpainel\/category\/{category}","methods":["PUT","PATCH"]},"admin.category.destroy":{"uri":"admpainel\/category\/{category}","methods":["DELETE"]},"api.category.index":{"uri":"api\/category","methods":["GET","HEAD"]},"api.category.store":{"uri":"api\/category","methods":["POST"]},"api.category.show":{"uri":"api\/category\/{category}","methods":["GET","HEAD"]},"api.category.update":{"uri":"api\/category\/{category}","methods":["PUT","PATCH"]},"api.category.destroy":{"uri":"api\/category\/{category}","methods":["DELETE"]},"api.menu.add.content":{"uri":"api\/menu\/add\/content","methods":["POST"]},"api.menu.delete":{"uri":"api\/menu\/delete","methods":["POST"]},"api.menu.create":{"uri":"api\/menu\/create","methods":["POST"]},"api.menu.item.save":{"uri":"api\/menu\/item\/save","methods":["POST"]},"api.menu.item.edit":{"uri":"api\/menu\/item\/edit","methods":["POST"]},"api.menu.item.delete":{"uri":"api\/menu\/item\/delete\/{id}","methods":["POST"]},"api.menu.item.reorder":{"uri":"api\/menu\/item\/reorder","methods":["POST"]},"api.v2.menu.index":{"uri":"api\/v2\/menu","methods":["GET","HEAD"]},"api.v2.menu.store":{"uri":"api\/v2\/menu","methods":["POST"]},"api.v2.menu.show":{"uri":"api\/v2\/menu\/{menu}","methods":["GET","HEAD"]},"api.v2.menu.update":{"uri":"api\/v2\/menu\/{menu}","methods":["PUT","PATCH"]},"api.v2.menu.destroy":{"uri":"api\/v2\/menu\/{menu}","methods":["DELETE"]},"admin.product.index":{"uri":"admpainel\/product","methods":["GET","HEAD"]},"admin.product.create":{"uri":"admpainel\/product\/create","methods":["GET","HEAD"]},"admin.product.store":{"uri":"admpainel\/product","methods":["POST"]},"admin.product.edit":{"uri":"admpainel\/product\/{product}\/edit","methods":["GET","HEAD"]},"admin.product.update":{"uri":"admpainel\/product\/{product}","methods":["PUT","PATCH"]},"admin.product.destroy":{"uri":"admpainel\/product\/{product}","methods":["DELETE"]},"api.product.quick-view":{"uri":"api\/product\/quick-view","methods":["GET","HEAD"]},"api.product.index":{"uri":"api\/product","methods":["GET","HEAD"]},"api.product.store":{"uri":"api\/product","methods":["POST"]},"api.product.show":{"uri":"api\/product\/{product}","methods":["GET","HEAD"]},"api.product.update":{"uri":"api\/product\/{product}","methods":["PUT","PATCH"]},"api.product.destroy":{"uri":"api\/product\/{product}","methods":["DELETE"]},"api.product_variant.index":{"uri":"api\/product_variant","methods":["GET","HEAD"]},"api.product_variant.store":{"uri":"api\/product_variant","methods":["POST"]},"api.product_variant.show":{"uri":"api\/product_variant\/{product_variant}","methods":["GET","HEAD"]},"api.product_variant.update":{"uri":"api\/product_variant\/{product_variant}","methods":["PUT","PATCH"]},"api.product_variant.destroy":{"uri":"api\/product_variant\/{product_variant}","methods":["DELETE"]},"api.post.index":{"uri":"api\/post","methods":["GET","HEAD"]},"api.post.store":{"uri":"api\/post","methods":["POST"]},"api.post.show":{"uri":"api\/post\/{post}","methods":["GET","HEAD"]},"api.post.update":{"uri":"api\/post\/{post}","methods":["PUT","PATCH"]},"api.post.destroy":{"uri":"api\/post\/{post}","methods":["DELETE"]},"admin.post.index":{"uri":"admpainel\/post","methods":["GET","HEAD"]},"admin.post.create":{"uri":"admpainel\/post\/create","methods":["GET","HEAD"]},"api.comment.post":{"uri":"admpainel\/post","methods":["POST"]},"admin.post.edit":{"uri":"admpainel\/post\/{post}\/edit","methods":["GET","HEAD"]},"admin.post.update":{"uri":"admpainel\/post\/{post}","methods":["PUT","PATCH"]},"admin.post.destroy":{"uri":"admpainel\/post\/{post}","methods":["DELETE"]},"api.template.change":{"uri":"api\/template\/change","methods":["GET","HEAD"]},"api.template.compile_admin_css":{"uri":"api\/template\/compile_admin_css","methods":["GET","HEAD"]},"api.template.compile_admin_live_edit_css":{"uri":"api\/template\/compile_admin_live_edit_css","methods":["GET","HEAD"]},"api.template.get_admin_css_url":{"uri":"api\/template\/get_admin_css_url","methods":["GET","HEAD"]},"api.template.reset_admin_stylesheet":{"uri":"api\/template\/reset_admin_stylesheet","methods":["GET","HEAD"]},"api.template.reset_admin_stylesheet_colors":{"uri":"api\/template\/reset_admin_stylesheet_colors","methods":["GET","HEAD"]},"admin.order.abandoned":{"uri":"admpainel\/order\/abandoned","methods":["GET","HEAD"]},"admin.order.index":{"uri":"admpainel\/order","methods":["GET","HEAD"]},"admin.order.show":{"uri":"admpainel\/order\/{order}","methods":["GET","HEAD"]},"api.order.index":{"uri":"api\/order","methods":["GET","HEAD"]},"api.order.store":{"uri":"api\/order","methods":["POST"]},"api.order.show":{"uri":"api\/order\/{order}","methods":["GET","HEAD"]},"api.order.update":{"uri":"api\/order\/{order}","methods":["PUT","PATCH"]},"api.order.destroy":{"uri":"api\/order\/{order}","methods":["DELETE"]},"checkout.cart":{"uri":"cart","methods":["GET","HEAD"]},"checkout.contact_information":{"uri":"contact-information","methods":["GET","HEAD"]},"checkout.contact_information_save":{"uri":"contact-information-save","methods":["POST"]},"checkout.shipping_method":{"uri":"shipping-method","methods":["GET","HEAD"]},"checkout.shipping_method_change":{"uri":"shipping-method-change","methods":["POST"]},"checkout.shipping_method_save":{"uri":"shipping-method-save","methods":["POST"]},"checkout.payment_method":{"uri":"payment-method","methods":["GET","HEAD"]},"checkout.payment_method_change":{"uri":"payment-method-change","methods":["POST"]},"checkout.payment_method_save":{"uri":"payment-method-save","methods":["POST"]},"login":{"uri":"login","methods":["GET","HEAD"]},"checkout.register":{"uri":"register","methods":["GET","HEAD"]},"checkout.finish":{"uri":"finish\/{id}","methods":["GET","HEAD"]},"api.checkout.":{"uri":"api\/checkout\/validate","methods":["POST"]},"shop.shipping.set_provider":{"uri":"api\/shop\/shipping\/set_provider","methods":["GET","POST","HEAD"]},"api.offer.store":{"uri":"api\/offer_save","methods":["POST"]},"api.offer.delete":{"uri":"api\/offer_delete","methods":["POST"]},"api.offer.get_all":{"uri":"api\/offers_get_all","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.file-manager.list":{"uri":"api\/file-manager\/list","methods":["GET","HEAD"]},"api.post.form":{"uri":"api\/post_form","methods":["POST"]},"api.option.save":{"uri":"api\/save_option","methods":["POST"]},"admin.backup.restore":{"uri":"admpainel\/backup\/restore","methods":["GET","HEAD"]},"admin.backup.start":{"uri":"admpainel\/backup\/start","methods":["GET","HEAD"]},"admin.backup.download":{"uri":"admpainel\/backup\/download","methods":["GET","HEAD"]},"admin.backup.generate-session-id":{"uri":"admpainel\/backup\/generate-session-id","methods":["GET","HEAD"]},"admin.backup.upload":{"uri":"admpainel\/backup\/upload","methods":["POST"]},"admin.backup.delete":{"uri":"admpainel\/backup\/delete","methods":["POST"]},"admin.backup.language.export":{"uri":"admpainel\/backup\/language\/export","methods":["POST"]},"admin.backup.language.upload":{"uri":"admpainel\/backup\/language\/upload","methods":["POST"]},"admin.customers.delete":{"uri":"admpainel\/customers\/delete","methods":["POST"]},"admin.customers.index":{"uri":"admpainel\/customers","methods":["GET","HEAD"]},"admin.customers.create":{"uri":"admpainel\/customers\/create","methods":["GET","HEAD"]},"admin.customers.store":{"uri":"admpainel\/customers","methods":["POST"]},"admin.customers.show":{"uri":"admpainel\/customers\/{customer}","methods":["GET","HEAD"]},"admin.customers.edit":{"uri":"admpainel\/customers\/{customer}\/edit","methods":["GET","HEAD"]},"admin.customers.update":{"uri":"admpainel\/customers\/{customer}","methods":["PUT","PATCH"]},"admin.customers.destroy":{"uri":"admpainel\/customers\/{customer}","methods":["DELETE"]},"admin.notification.read":{"uri":"admpainel\/notification\/read","methods":["POST"]},"admin.notification.reset":{"uri":"admpainel\/notification\/reset","methods":["POST"]},"admin.notification.delete":{"uri":"admpainel\/notification\/delete","methods":["POST"]},"admin.notification.test_mail":{"uri":"admpainel\/notification\/test_mail","methods":["POST"]},"admin.notification.index":{"uri":"admpainel\/notification","methods":["GET","HEAD"]},"api.comment.admin.edit":{"uri":"admpainel\/edit","methods":["POST"]},"admin.comment.comment.index":{"uri":"admpainel\/comment","methods":["GET","HEAD"]},"api.multilanguage.geolocaiton_test":{"uri":"api\/multilanguage\/geolocaiton_test","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"api.multilanguage.change_language":{"uri":"api\/multilanguage\/change_language","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"admin.multilanguage.index":{"uri":"admpainel\/multilanguage","methods":["GET","HEAD"]},"debugbar.openhandler":{"uri":"_debugbar\/open","methods":["GET","HEAD"]},"debugbar.clockwork":{"uri":"_debugbar\/clockwork\/{id}","methods":["GET","HEAD"]},"debugbar.assets.css":{"uri":"_debugbar\/assets\/stylesheets","methods":["GET","HEAD"]},"debugbar.assets.js":{"uri":"_debugbar\/assets\/javascript","methods":["GET","HEAD"]},"debugbar.cache.delete":{"uri":"_debugbar\/cache\/{key}\/{tags?}","methods":["DELETE"]},"standalone-updater.about-new-version":{"uri":"admpainel\/standalone-updater\/about-new-version","methods":["GET","HEAD"]},"api.standalone-updater.delete-temp":{"uri":"api\/standalone-updater\/delete-temp","methods":["GET","HEAD"]},"api.standalone-updater.update-now":{"uri":"api\/standalone-updater\/update-now","methods":["POST"]},"api.standalone-updater.remove-dashboard-notice":{"uri":"api\/standalone-updater\/remove-dashboard-notice","methods":["GET","HEAD"]},"api.coupon_apply":{"uri":"api\/coupon_apply","methods":["POST"]},"api.coupons_delete_session":{"uri":"api\/coupons_delete_session","methods":["POST"]},"api.coupons_save_coupon":{"uri":"api\/coupons_save_coupon","methods":["POST"]},"api.coupon_delete":{"uri":"api\/coupon_delete","methods":["POST"]},"api.save_mail_template":{"uri":"api\/save_mail_template","methods":["POST"]},"api.delete_mail_template":{"uri":"api\/delete_mail_template","methods":["POST"]},"admin.blog.filter.get-custom-fields-table":{"uri":"admpainel\/blog\/filter\/get-custom-fields-table","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"admin.shop.filter.get-custom-fields-table":{"uri":"admpainel\/shop\/filter\/get-custom-fields-table","methods":["POST"]},"adminadmin.index":{"uri":"admpainel","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"adminadmin.all":{"uri":"admpainel\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"apijs":{"uri":"apijs\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"csrf":{"uri":"csrf","methods":["POST"]},"module":{"uri":"module\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"api":{"uri":"api_nosession\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"api_html":{"uri":"api_html\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"editor_tools":{"uri":"editor_tools\/{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"home":{"uri":"\/","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"robots":{"uri":"robots.txt","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"sitemap.index":{"uri":"sitemap.xml","methods":["GET","HEAD"]},"sitemap.categories":{"uri":"sitemap.xml\/categories","methods":["GET","HEAD"]},"sitemap.tags":{"uri":"sitemap.xml\/tags","methods":["GET","HEAD"]},"sitemap.products":{"uri":"sitemap.xml\/products","methods":["GET","HEAD"]},"sitemap.posts":{"uri":"sitemap.xml\/posts","methods":["GET","HEAD"]},"sitemap.pages":{"uri":"sitemap.xml\/pages","methods":["GET","HEAD"]},"rss.index":{"uri":"rss","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"rss.products":{"uri":"rss-products","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"rss.posts":{"uri":"rss-posts","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"]},"all":{"uri":"{all}","methods":["GET","HEAD","POST","PUT","PATCH","DELETE","OPTIONS"],"wheres":{"all":".*"}},"passport.token":{"uri":"oauth\/token","methods":["POST"]},"passport.token.refresh":{"uri":"oauth\/token\/refresh","methods":["POST"]},"passport.authorizations.authorize":{"uri":"oauth\/authorize","methods":["GET","HEAD"]},"passport.authorizations.approve":{"uri":"oauth\/authorize","methods":["POST"]},"passport.authorizations.deny":{"uri":"oauth\/authorize","methods":["DELETE"]},"passport.tokens.index":{"uri":"oauth\/tokens","methods":["GET","HEAD"]},"passport.tokens.destroy":{"uri":"oauth\/tokens\/{token_id}","methods":["DELETE"]},"passport.clients.index":{"uri":"oauth\/clients","methods":["GET","HEAD"]},"passport.clients.store":{"uri":"oauth\/clients","methods":["POST"]},"passport.clients.update":{"uri":"oauth\/clients\/{client_id}","methods":["PUT"]},"passport.clients.destroy":{"uri":"oauth\/clients\/{client_id}","methods":["DELETE"]},"passport.scopes.index":{"uri":"oauth\/scopes","methods":["GET","HEAD"]},"passport.personal.tokens.index":{"uri":"oauth\/personal-access-tokens","methods":["GET","HEAD"]},"passport.personal.tokens.store":{"uri":"oauth\/personal-access-tokens","methods":["POST"]},"passport.personal.tokens.destroy":{"uri":"oauth\/personal-access-tokens\/{token_id}","methods":["DELETE"]},"admin.import-export-tool.":{"uri":"admpainel\/import-export-tool\/waw","methods":["GET","HEAD"]},"admin.import-export-tool.index":{"uri":"admpainel\/import-export-tool\/index","methods":["GET","HEAD"]},"admin.import-export-tool.import":{"uri":"admpainel\/import-export-tool\/import\/{id}","methods":["GET","HEAD"]},"admin.import-export-tool.import-start":{"uri":"admpainel\/import-export-tool\/import-start\/{id}","methods":["GET","HEAD"]}}};
...
mw.askusertostay = false;
  ...
  mw.require = function(url, inHead, key) {
    ...
    var t = url.split('.').pop();
    url = url.contains('//') ? url : (t !== "css" ? "http://localhost/cidadaoon/userfiles/modules/microweber/api/" + url  :  "http://localhost/cidadaoon/userfiles/modules/microweber/css/" + url);
...
mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/jquery.js");



mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/tools.js");
mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/cookie.js");



mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/forms.js");

mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/url.js");

mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/events.js");

//mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/upgrades.js");
mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/session.js");

mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/shop.js");

mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/common.js");

mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/components.js");

mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/dialog.js");
mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/instruments.js");
mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/forms.js");
mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/fonts.js");

//mw.required.push("http://localhost/cidadaoon/userfiles/modules/microweber/api/content.js");
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/base64.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/checkbox.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/colorpicker.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/common-extend.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/common.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/dialog.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/domhelpers.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/dropdown.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/editor.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/element.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/elementedit.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/external.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/extradata-form.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/fullscreen.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/gallery.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/helpers.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/iframe-tools.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/images.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/jquery.tools.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/loading.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/loops.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/modules-dialogs.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/native-notification.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/notification.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/objects.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/responsive.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/select.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/spinner.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/storage.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/system-dialogs.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/tabs.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/tooltip.js');
...
mw.required.push('http://localhost/cidadaoon/userfiles/modules/microweber/api/tools/uiaccordion.js');
